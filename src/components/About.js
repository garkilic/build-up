	...
	return (
		<div className="containers container" id="about">
			<div className="container--one">
				...
				<p>
					Answer 10 simple questions that will help your personal trainer create
			...
			<div className="container--two">
				...
				<p>
					Within 48 hours, you will receive your custom workout plan via email.
				</p>
			</div>
			...
			<div className="container--three">
				...
				<p>
					Follow your personalized plan and reap the benefits of a workout made
					for you.
				</p>
			</div>
		</div>
